...
- [Fine-phase split on `ImpactEngine.DiffAsync`](../needs-review/aaa-web-timing-fine-phase-split-on-impact-diff.md)
  — held in `needs-review/`, because this card itself calls it "a precision nice-to-have ... not urgent".
