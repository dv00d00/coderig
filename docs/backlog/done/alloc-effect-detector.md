...
**Related:** [[redundant-graph-index-rebuild-per-query]] + [[derivation-cache-5-warm-graph-across-queries]].
...
- [Value-copy facts — the struct-copy companion detector](../needs-review/value-copy-facts-companion-detector.md)
- [Allocation-returning library summaries, measured rather than inferred](../needs-review/allocation-returning-library-summaries.md)
- [Allocation mechanisms still uncovered: initializers, collection expressions, async state machines](../needs-review/allocation-mechanism-coverage-gaps.md)
