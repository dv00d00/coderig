...
patch audit, during the [live-background-index](../progress/live-background-index.md) spike pool) ·
...
- The **server** side is correctly hedged: every disk cache key folds in `QueryCacheKeys.StoreKey` (rig.db
  ...
  [web-api-seed-and-effect-disclosure-parity](web-api-seed-and-effect-disclosure-parity.md).
...
- Blocks nothing in [live-background-index](../progress/live-background-index.md), but a live/mutable store
